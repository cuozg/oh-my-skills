...
- `references/asset-review-checklist.md` — shader, texture, animation, import settings checklist

Load references on demand via `read_skill_file("unity-review-asset", "references/asset-review-checklist")`.
