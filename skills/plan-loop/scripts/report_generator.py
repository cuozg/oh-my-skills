#!/usr/bin/env python3
"""
Report Generator — Format and write plan-loop completion report.
...
def generate_report(state_file: Path, output_file: Optional[Path] = None) -> str:
    ...
    # Build report
    report = []
    report.append("# Plan Loop Completion Report\n")
...
def main():
    parser = argparse.ArgumentParser(description="Generate Plan Loop Completion Report")
