...
3. **Analyze** — Read `../../unity-shared/references/investigation-analysis-rules.md`, apply rules for relevant type(s).

4. **Report** — Read `output-template.md` template, fill type field, populate sections, delete unused §8.x sections, include Mermaid diagrams, save.
