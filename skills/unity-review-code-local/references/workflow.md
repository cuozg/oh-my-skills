...
Get diff (see `../../unity-shared/references/common-rules.md` Input table). For feature/logic requests, identify files via grep/LSP first.
...
Spawn explore agents per `../../unity-shared/references/review-deep-workflow.md`: call-site analysis, state flow, data contracts. Enforce `../../unity-shared/references/review-gates.md` evidence rules.
...
- **Review only** — insert `// ── REVIEW` comments only. Never apply code fixes directly.
