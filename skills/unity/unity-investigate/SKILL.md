...
1. Read the template at `.opencode/skills/unity/unity-investigate/assets/templates/INVESTIGATION_REPORT.md`
...
### Phase 2: Discovery
1. Run `.opencode/skills/unity/unity-investigate/scripts/trace_logic.sh [Target]` to map references
