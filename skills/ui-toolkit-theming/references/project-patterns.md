...
> DC patterns #1–8. For patterns #9–16, see [project-patterns-advanced.md](project-patterns-advanced.md). Unity 6+ templates → [code-templates.md](code-templates.md). QuizU patterns → [quizu-patterns.md](quizu-patterns.md).
...
See [project-patterns-advanced.md](project-patterns-advanced.md) for patterns #9–16 (3D tracking, state, animation, layout, mobile safe areas).
