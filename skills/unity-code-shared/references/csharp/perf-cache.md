...
Continued from [perf-alloc.md](perf-alloc.md).
...
**See also:** [perf-alloc.md](perf-alloc.md) for Allocation Reduction, String Optimizations, Collections, Struct/Class, Boxing, and Arrays.
