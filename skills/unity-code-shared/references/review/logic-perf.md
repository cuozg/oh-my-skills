...
Continue reading in **logic-serial.md** for Serialization, Control Flow, Logic, and State Management patterns. See **logic-data.md** for Data Flow, Concurrency, UI, Networking, Unity Gotchas, Edge Cases.
