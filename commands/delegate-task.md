...
Delegate task to @sisyphus-junior with skill included in the investigate opencode and oh-my-opencode, find a way to change the setting that can spawn @sisyphus via subtask will full  Behavior instructions, phases, protocols with minimum token cost  and [atomic prompt]
---
