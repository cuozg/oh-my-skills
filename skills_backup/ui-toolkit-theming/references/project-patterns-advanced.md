# Project Architecture Patterns — Advanced

> See [project-patterns.md](project-patterns.md) for patterns #1–8 (Event Bus, MVC, UIDocument, Theming, Custom Controls, Async, Composite, Dynamic UI).
